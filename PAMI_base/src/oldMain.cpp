// /**
//  * @file main.cpp
//  * @brief Ancien programme principal, a implementer dans la pami
//  **/
...
// long old_time = 0; // Variable de temps ou on stocke le temps actuel
...
//   if (old_time + 500 < millis()) // Log toutes les secondes
//   {
