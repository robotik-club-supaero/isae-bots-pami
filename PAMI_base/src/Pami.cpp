...
unsigned long Pami::bouger_servo_non_bloquant(int etape_d_appel, float angle, unsigned long oldtime)
{
...
unsigned long Pami::allumer_pompe(int etape_d_appel, unsigned long oldtime)
{
    if (etape_d_appel != etape_globale)
    {
        return oldtime;
...
unsigned long Pami::eteindre_pompe(int etape_d_appel, unsigned long oldtime)
{
    if (etape_d_appel != etape_globale)
    {
        return oldtime;
